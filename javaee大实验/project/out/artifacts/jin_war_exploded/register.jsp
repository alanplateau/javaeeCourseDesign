...
<head>
    ...
    <script type="text/javascript" language="JavaScript" src="js/verificationForRegister.js"></script>
</head>
    ...
    <form action="registerAction.action" method="post">
        <div class='login_fields'>
            <div class='login_fields__user'>
                ...
                <input name="user.account"  id="account" placeholder='用户名' maxlength="11" type='text' value="<s:property value="phoneNumber"/>" autocomplete="off"/>
