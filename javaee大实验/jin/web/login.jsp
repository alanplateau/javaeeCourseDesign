    ...
    <form action="userAction.action" method="post">
        <div class='login_fields'>
            <div class='login_fields__user'>
                ...
                <input name="user.account"  id="account" laceholder='用户名' maxlength="16" type='text' value="kbcxy" autocomplete="off" />
            ...
            <div class='login_fields__password'>
                ...
                <input name="user.password" placeholder='密码' maxlength="16" type='password' autocomplete="off">
                <div class='validation'>
                    <img alt="" src='img/tick.png'>
                </div>
            </div>
...
<%--            </div>--%>
            ...
            <div style="position: relative;left: 100px;top:30px;">
                <a href="verificationLogin.jsp" style="color: white">手机验证码快速登录</a>
            </div>
