<%--
  ...
  ~    项目名称:ARS55version
  ~    文件名称:verificationLogin.jsp
  ~    Date:2019/12/27 上午10:23
  ~    Author:高源
  --%>
...
<head>
    ...
    <script type="text/javascript" language="JavaScript" src="js/verificationJs.js"></script>
</head>
...
<div class='login'>
    ...
    <form action="loginByCodeAction.action" method="post">
        <div class='login_fields'>
            <div class='login_fields__user'>
                <div class='icon'>
                    <img alt="" src='img/user_icon_copy.png'>
                </div>
                <input name="user.account"  id="account" laceholder='用户名' maxlength="16" type='text' autocomplete="off" value="<s:property value="phoneNumber"/> " />
            ...
            <!--                </div>-->
            <!--                <input name="user.password" placeholder='密码' maxlength="16" type='text' autocomplete="off">-->
            <!--                <div class='validation'>-->
            <!--                    <img alt="" src='img/tick.png'>-->
            <!--                </div>-->
            <!--            </div>-->
            <div class='login_fields__password'>
                ...
                <div class='validation' style="opacity: 1;top:5px;">
                    <!--						<canvas class="J_codeimg" id="myCanvas" onclick="Code();">对不起，您的浏览器不支持canvas，请下载最新版浏览器!</canvas>-->
                    <button type="button" id="sendVerification" class="check-button1" style="z-index: 999">发送验证码</button>
                </div>
            </div>
            ...
            <div style="position: relative;left: 100px;top:30px;">
                <a href="login.jsp" style="color: white">密码登录</a>
            </div>
            <div style="position: relative;left: 100px;top:50px;">
                <a  href="register.jsp" style="color: white">还没有注册，去注册</a>
            </div>
