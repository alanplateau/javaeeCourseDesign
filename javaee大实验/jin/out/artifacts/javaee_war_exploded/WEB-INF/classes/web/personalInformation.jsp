        ...
        <div id="right" style="width: 85%; height: auto; float: left;">
            <div style="border: 1px solid #DEDEDE;">
                <div style="width: 1050px; float: left">
                    <div style="line-height: 50px; float: left; margin-left: 30px;">
                        <label style="font-weight: bold">基本信息</label>
                    </div>
                    <div style="line-height: 50px; float:left; margin-left: 730px;">
                        <a style="color: #000000;text-decoration:none" href="#" data-toggle="modal"
                           data-target="#myModal">修改密码</a>
                    </div>
                </div>
                <table align="center" valign="center">
                    <tr style="height: 30px">
                        <td align="right">用户名：</td>
                        <td><s:property value="#session.user.account"/></td>
                    </tr>
                </table>
            </div>
        </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div>
                <label style="font-weight: bold; font-size: large; margin-left: 20px; margin-top: 10px;">修改密码</label>
            </div>
            <form id="change" class="form-horizontal" role="form" style="margin: 10px;" method="post" action="updateUser.action">
                <div class="form-group">
                    <label for="user.account" class="col-sm-2 control-label">用户名：</label>
                    <div class="col-sm-10">
                        <input name="user.account" class="form-control" value="<s:property value="#session.user.account"/>" readonly="readonly">
                        <!--<s:textfield class="form-control" name="user.account"/>-->
                    </div>
                </div>
                <div class="form-group">
                    <label for="user.password" class="col-sm-2 control-label">密码：</label>
                    <div class="col-sm-10">
                        <s:password id="password" class="form-control" name="user.password"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="margin-left: 400px">
                    ...
                    <button id="submit" type="submit" class="btn btn-default" onclick="return insertManager()">提交</button>
                </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
