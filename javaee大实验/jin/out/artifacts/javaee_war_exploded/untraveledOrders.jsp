                    ...
                    <div>
                        <table class="table">
                            ...
                            <%!
                                int count = 1;
                            %>
                            <s:iterator value="#request.orders" var="forder">
                                <tr>
                                    <td><%=count%></td>
                                    <td>
                                    ...
                                    <td>
                                        <s:date name="orderTime" format="yyyy-MM-dd"/>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="refundTicket.action?order.orderId=<s:property value="orderId"/>" style="color: black">退票</a>
                                    </td>
                                </tr>
                                <%
                                    count++;
